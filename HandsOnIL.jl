...
# ╔═╡ 28357494-6960-47cb-a110-78e736278465
using Pkg

# ╔═╡ 55bcbdee-e743-4ba8-ab4a-44b58608c452
# ╠═╡ show_logs = false
pkg"add https://github.com/ancorso/Crux.jl"

# ╔═╡ b9dad824-b1fc-4eb3-b3ab-9a3138109e87
# ╠═╡ show_logs = false
pkg"add https://github.com/ancorso/POMDPGym.jl"

# ╔═╡ c354b317-47d6-4975-86b1-52cd8a8f6cff
using PlutoUI

# ╔═╡ 70cb08f3-46db-4bdf-bdca-0b42fa18ba24
# ╠═╡ show_logs = false
using Crux, Flux, POMDPs, BSON

# ╔═╡ 93311bcf-9543-49bb-a876-074f3d97591f
using POMDPGym

# ╔═╡ 4f13d550-7df7-11f1-2095-a35fc5bcc909
md"# HandsOn Imitation Learning"

# ╔═╡ 3c19fd7c-f22c-4b59-b195-5b395bd7476d
md"""
## Swinging Pendulum
...
# ╔═╡ 4bbd4f4b-ef9c-425b-bc7c-d6ecd9855563
md"""
Fill a buffer with expert trajectories.
"""

# ╔═╡ 6497f4f6-b687-4e86-ac89-dcd32f166cdf
begin
...
# ╔═╡ ce0e4f4a-74b3-400c-ae9b-395662360e66
expert_trajectories.data

# ╔═╡ 1cc2c20a-204d-4feb-9b47-69b5b8920b16
md"## Pendulum MDP"

# ╔═╡ 4897ee3a-2169-4690-9292-ee4531c6d461
mdp = PendulumMDP();

# ╔═╡ e6bcdcd2-3247-4213-a5b2-672ddc2e6fd1
md"""
...
# ╔═╡ eb9ac549-7d45-48ea-b8e2-e70d2deced69
𝒮 = state_space(mdp)

# ╔═╡ 28982181-8b29-4586-b865-77aa743198b8
md"""
## Behavior Cloning
...
# ╔═╡ 8ceed1ea-2420-4efd-8a76-03d173495b76
function π_network()
...
# ╔═╡ 3010033f-b465-4416-b15c-5ce00de55727
md"""
...
# ╔═╡ e3343a5a-b495-47b0-bf17-7ac3e7819726
action_space(policy)

# ╔═╡ 4394a307-35ac-4a9f-a80d-5718491c9422
md"""
...
# ╔═╡ a8230954-f993-4729-8ec1-35911555bb49
md"""
## Inspecting Actions
Let's now inspect the actions output by the learned policy.
"""

# ╔═╡ 20cd78f9-4a32-4ed0-adb5-76c1d724f387
md"θ: $(@bind θ Slider(-π:0.01:π, default=0, show_value=true)) | ω: $(@bind ω Slider(-1:0.01:1, default=0, show_value=true))"

# ╔═╡ 2f71da61-0104-4acf-9e28-47f0ddf54131
s = [θ, ω]

# ╔═╡ 000cb17b-8680-49a5-ade6-e6da56e8f2b6
a = action(policy, s)

# ╔═╡ abd0f373-3e46-4f04-adc9-23c2302dd734
render(mdp, s, a)
...
manifest_format = "2.0"
project_hash = "27965e9b36832ed9cda14e68626d671ee07dd65e"
