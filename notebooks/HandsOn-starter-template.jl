...
# ╔═╡ b8ded0b0-792f-11f1-06ba-e773989a12d1
using POMDPs, QuickPOMDPs, POMDPModelTools, POMDPPolicies, Parameters, Plots, StatsBase

# ╔═╡ b8ded0b0-792f-11f1-3c7a-9136f7f7c6a3
using PlutoUI

# ╔═╡ b8ded0b0-792f-11f1-3487-dfe8bf0664e2
md"""
# HandsOn: (rename this notebook & title)

Starter notebook — the package environment below is already pinned/known-good
(Plots + StatsBase locked). Duplicate this file for each new HandsOn notebook
instead of starting from a blank Pluto notebook, so you don't hit the
precompile crash again.
"""

# ╔═╡ b8ded0b0-792f-11f1-0e5c-81abdfab41a5
...
manifest_format = "2.0"
project_hash = "0cffea9c235aea75c91eccae1441b9e5bfbaae34"
